...
# (Contém Veto Explícito para Negação e Whitelist CORS da Extensão)
...
app = FastAPI(
    ...
    description="API unificada da plataforma GitRAG para análise, rastreabilidade de requisitos e relatórios (imediatos e agendados) baseados em repositórios GitHub.",
    version="0.4.0",
)

# --- CORREÇÃO CRÍTICA DE CORS ---
# O ID da sua extensão é ajiinnakfafbdkfmodpbmdlbegjmehfh
EXTENSION_ORIGIN = "chrome-extension://ajiinnakfafbdkfmodpbmdlbegjmehfh"
HEROKU_URL = "https://meu-tcc-testes-041c1dd46d1d.herokuapp.com"
# A inclusão explícita resolve o problema de 'Access-Control-Allow-Origin'
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        EXTENSION_ORIGIN, 
...
async def _route_intent(
    ...
    is_negation = last_user_prompt.strip().lower() in NEGATION_WORDS # Palavra de negação
