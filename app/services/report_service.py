...
# (Alterado para retornar 'filename' em vez de 'public_url')
...
# --- SERVIÇO DE ARMAZENAMENTO SUPABASE (NÃO MUDA) ---
# (Usando o método 'requests' que você já tem)
class SupabaseStorageService:
    ...
    def upload_file_content(self, content_string: str, filename: str, bucket_name: str, content_type: str = 'text/html'):
        ...
        try:
            ...
            # O upload ainda retorna a URL, mas não a usaremos
...
# -------------------------------------------------------------------------
# A CLASSE ReportService NÃO MUDA
# -------------------------------------------------------------------------
...
# --- FUNÇÃO DO WORKER (MUDANÇA NO 'return') ---
...
def processar_e_salvar_relatorio(repo_name: str, user_prompt: str, format: str = "html"):
    ...
    try:
        ...
        # Esta função (upload_file_content) ainda está funcionando
        # Ela apenas salva o arquivo no Supabase
        ...
        # Não retornamos mais a URL pública
        return filename
